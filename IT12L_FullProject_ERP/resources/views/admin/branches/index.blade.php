                ...
                <div class="branch-card">
                    ...
                    <div class="branch-card-body">
                        ...
                        <div class="branch-stats">
                            <div class="stat-item">
                                <div class="stat-value orders">{{ $branch->orders_count ?? 0 }}</div>
                                <div class="stat-label">Total Orders</div>
                            </div>
                            <div class="stat-divider"></div>
                            <div class="stat-item">
                                <div class="stat-value menu">{{ $branch->available_menu_items_count ?? 0 }}</div>
                                <div class="stat-label">Available Menu</div>
                            </div>
                            <div class="stat-divider"></div>
                            <div class="stat-item">
                                <div class="stat-value inventory">{{ $branch->inventories_count ?? 0 }}</div>
                        ...
                        <div class="branch-actions">
                            <a href="{{ route('admin.branches.show', $branch->id) }}" class="btn btn-primary flex-fill">
                                <i class="fas fa-eye"></i> View Operations
                            </a>
                            <a href="{{ route('admin.branches.edit', $branch->id) }}" class="btn btn-warning">
