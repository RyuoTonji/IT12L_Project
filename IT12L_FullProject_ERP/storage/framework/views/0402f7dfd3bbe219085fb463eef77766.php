        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="timeline">
                        <!-- Order Placed -->
                        <div class="timeline-item <?php echo e(in_array($order->status, ['pending', 'confirmed', 'delivered']) ? 'active' : ''); ?>">
                        ...
                        <!-- Confirmed -->
                        <div class="timeline-item <?php echo e(in_array($order->status, ['confirmed', 'delivered']) ? 'active' : ''); ?>">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-muted small mb-0">
                                    <?php echo e(in_array($order->status, ['confirmed', 'delivered']) ? 'Your order has been confirmed' : 'Waiting for confirmation'); ?>
                        ...
                        <div class="timeline-item <?php echo e($order->status === 'delivered' ? 'active' : ''); ?>">
                            ...
                            <div class="timeline-content">
                                <h6>Delivered</h6>
                                <p class="text-muted small mb-0">
                                    <?php echo e($order->status === 'delivered' ? 'Order has been delivered' : 'Pending delivery'); ?>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0"><strong>Delivery Address:</strong><br><?php echo e(nl2br(e($order->address))); ?></p>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Videos\Project_IT12\sabio\IT12L_Project\IT12L_FullProject_ERP\resources\views/user/orders/show.blade.php ENDPATH**/ ?>