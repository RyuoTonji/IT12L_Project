                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    @if($item->product->image)
                                                        <img src="{{ asset('images/' . $item->product->image) }}" alt="{{ $item->product->name }}" class="img-thumbnail me-2" style="width: 50px; height: 50px; object-fit: cover;">
                                                    @else
                        ...
                        <form method="POST" action="{{ route('checkout.process') }}" id="checkout-form">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('customer_name') is-invalid @enderror"
                                    id="customer_name" name="customer_name" value="{{ old('customer_name', $user->name) }}"
                                    required>
                                @error('customer_name')
                            ...
                            <div class="mb-3">
                                ...
                                @if(empty($user->phone))
                                    <div class="form-check mt-1">
                                        <input class="form-check-input" type="checkbox" name="save_phone" id="save_phone"
                                            value="1" checked>
                                        <label class="form-check-label small text-muted" for="save_phone">
                            ...
                            <div class="mb-3">
                                <label for="address" class="form-label">
                                    Pickup Address / Location <span class="text-danger">*</span>
                                </label>
                                <textarea class="form-control @error('address') is-invalid @enderror" id="address"
                                    name="address" rows="2" placeholder="Your address..."
                                    required>{{ old('address', $user->address ?? '') }}</textarea>
                                @if(empty($user->address))
                                    <div class="form-check mt-1">
                                        <input class="form-check-input" type="checkbox" name="save_address" id="save_address"
                                            value="1" checked>
                                        <label class="form-check-label small text-muted" for="save_address">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div
                                        class="form-check border rounded p-3 @if(old('payment_method') == 'qr_ph') border-primary bg-light @endif">
                                        <input class="form-check-input" type="radio" name="payment_method" id="payment_qrph"
                                            value="qr_ph" {{ old('payment_method') == 'qr_ph' ? 'checked' : '' }}>
                                        <label class="form-check-label w-100" for="payment_qrph">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <br><small class="text-muted">Pay via GCash, Maya, ShopeePay, or any
                                                        Bank App</small>
                                                </div>
                                            </div>
                                        </label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" id="modal-body-content">
                    ...
                    <div class="border border-info rounded p-3 mb-3" id="order-summary-section"
                        style="background-color: #d1ecf1; display: block !important; opacity: 1 !important; visibility: visible !important;">
                        ...
                        <ul class="mb-0 mt-2">
                            ...
                            <li><strong>Address:</strong> <span
                                    id="summary-address">{{ $user->address ?? 'Not provided' }}</span></li>
                    ...
                    <div id="paymongo-qr-section" style="display: none;" class="text-center mb-3">
                        ...
                        <div id="qr-status-section" class="mt-4">
                            <div class="d-flex align-items-center justify-content-center gap-2">
                                ...
                                <span class="badge bg-warning text-dark px-3 py-2" id="qr-badge">Waiting for
                                    Payment...</span>
                            </div>
                ...
                placeOrderBtn?.addEventListener('click', function (e) {
                    ...
                    if (form.checkValidity()) {
                        ...
                        if (addressInput && summaryAddress) {
                            summaryAddress.innerText = addressInput.value;
                        }
