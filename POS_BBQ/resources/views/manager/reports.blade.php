...
@section('content')
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
        <div class="p-6">
            ...
            <p class="text-gray-600 mt-2">View and analyze performance reports</p>
        </div>
    </div>
        ...
        <div class="p-6 text-gray-900">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('manager.reports.daily') }}"
                    ...
                    <h2 class="text-lg font-medium mb-2">Daily Consolidation</h2>
                ...
                <a href="{{ route('manager.reports.staff') }}"
                    ...
                    <h2 class="text-lg font-medium mb-2">Staff Report</h2>
                ...
                <a href="{{ route('manager.reports.sales') }}"
                    ...
                    <h2 class="text-lg font-medium mb-2">Daily Report</h2>
                ...
                <a href="{{ route('manager.reports.inventory') }}"
                    ...
                    <h2 class="text-lg font-medium mb-2">Inventory Report</h2>
                    <p class="text-gray-600">View ingredients activity and prepared dishes</p>
                </a>
            </div>
        </div>
    </div>
