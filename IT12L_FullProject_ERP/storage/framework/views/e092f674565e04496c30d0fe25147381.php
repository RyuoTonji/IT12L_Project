                ...
                <div class="filter-group">
                    <div class="form-group">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="preparing" <?php echo e(request('status') == 'preparing' ? 'selected' : ''); ?>>Preparing
                            </option>
                            <option value="ready" <?php echo e(request('status') == 'ready' ? 'selected' : ''); ?>>Ready for Pickup
                            </option>
                            <option value="picked up" <?php echo e(request('status') == 'picked up' ? 'selected' : ''); ?>>Picked Up
                            </option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="customer-info">
                                            <strong><?php echo e($order->user->name ?? $order->customer_name); ?></strong>
                                            <small><?php echo e($order->user->email ?? 'Guest Order'); ?></small>
                                        </div>
                                    </td>
                                    <td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Videos\projectIT12\IT12L_FullProject_ERP\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>