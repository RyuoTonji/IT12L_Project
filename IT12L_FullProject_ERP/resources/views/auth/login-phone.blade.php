{{-- resources/views/auth/login-phone.blade.php --}}
@extends('layouts.app')
    ...
    <div class="login-right-side w-1/2 flex items-center justify-center">
        <div class="login-content w-full max-w-xs">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-4">
                ...
                <div>
                    <label for="phone" class="block text-lg font-medium text-white">Phone Number:</label>
                    <input 
                        type="text" 
                        id="phone" 
                        name="email" 
                    ...
                    <!-- Phone not found → red text + popup -->
                ...
                <div class="text-right mt-2">
                    <a href="{{ route('login') }}" class="text-sm text-white hover:text-gray-300 underline transition">
                        Login using email
                    </a>
                </div>
...
<!-- ONLY shows when phone number NOT FOUND (popup) -->
@error('email_not_found')
