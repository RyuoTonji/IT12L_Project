        ...
        <div class="card-body">
            ...
            <div class="btn-group flex-wrap" role="group">
                <a href="<?php echo e(route('browse', $branch->id)); ?>" 
                   class="btn btn-outline-primary <?php echo e(!request('category') ? 'active' : ''); ?>">
                    All Items
                </a>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(url('/browse/' . $branch->id . '/category/' . $category->id)); ?>" 
                   class="btn btn-outline-primary <?php echo e(request('category') == $category->id ? 'active' : ''); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Videos\Project_IT12\sabio\IT12L_Project\IT12L_FullProject_ERP\resources\views/user/home/browse.blade.php ENDPATH**/ ?>