                        ...
                        <table class="data-table table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">{{ number_format($branch->total_orders) }}</td>
                                    <td class="text-end fw-semibold text-success">₱{{ number_format($branch->total_sales, 2) }}</td>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="3">
                        ...
                        <table class="data-table table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end fw-semibold text-success">₱{{ number_format($product->total_sales, 2) }}</td>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="3">
