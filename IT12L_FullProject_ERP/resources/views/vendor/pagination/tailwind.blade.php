                        ...
                        @foreach ($element as $page => $url)
                            @if ($page == $paginator->currentPage())
                                <span aria-current="page">
                                    <span class="inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-brown-600 border border-brown-600 cursor-default leading-5" style="background-color: #A52A2A; border-color: #A52A2A;">{{ $page }}</span>
                                </span>
                            @else
