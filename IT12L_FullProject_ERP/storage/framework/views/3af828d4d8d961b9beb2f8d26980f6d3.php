            ...
            <div class="chart-card">
                ...
                <div class="chart-card-body text-center">
                    <div class="live-order-count">
                        ...
                        <h2 class="count-value"><?php echo e($recentOrderCount); ?></h2>
                        <p class="count-label">Orders</p>
                        <div class="trend-indicator <?php echo e($orderTrend >= 0 ? 'trend-up' : 'trend-down'); ?>">
                            <i class="fas fa-<?php echo e($orderTrend >= 0 ? 'arrow-up' : 'arrow-down'); ?>"></i>
                            <?php echo e(number_format(abs($orderTrend), 1)); ?>%
                    ...
                    <div class="quick-stats-grid">
                        <div class="quick-stat-item-compact">
                            ...
                            <div class="stat-info-compact">
                                <h4><?php echo e($orderStatusData['pending'] ?? 0); ?></h4>
                                <p>Pending</p>
                            </div>
                        </div>
                        <div class="quick-stat-item-compact">
                            ...
                            <div class="stat-info-compact">
                                <h4><?php echo e($orderStatusData['confirmed'] ?? 0); ?></h4>
                                <p>Confirmed</p>
                            </div>
                        </div>
                        <div class="quick-stat-item-compact">
                            ...
                            <div class="stat-info-compact">
                                <h4><?php echo e($orderStatusData['preparing'] ?? 0); ?></h4>
                                <p>Preparing</p>
                            </div>
                        </div>
                        <div class="quick-stat-item-compact">
                            ...
                            <div class="stat-info-compact">
                                <h4><?php echo e($orderStatusData['ready'] ?? 0); ?></h4>
                                <p>Ready</p>
                            </div>
                        </div>
                        <div class="quick-stat-item-compact">
                            ...
                            <div class="stat-info-compact">
                                <h4><?php echo e($orderStatusData['picked up'] ?? 0); ?></h4>
                                <p>Picked Up</p>
                            </div>
                        </div>
                        <div class="quick-stat-item-compact">
                            ...
                            <div class="stat-info-compact">
                                <h4><?php echo e($orderStatusData['cancelled'] ?? 0); ?></h4>
                                <p>Cancelled</p>
                            </div>
                        </div>
                    </div>
...
const salesFilterState = {
    startDate: "<?php echo e($salesStartDate ?? ''); ?>",
    endDate: "<?php echo e($salesEndDate ?? ''); ?>",
    branchId: 'all'
};

const statusFilterState = {
    startDate: "<?php echo e($statusStartDate ?? Carbon\Carbon::today()->format('Y-m-d')); ?>",
    endDate: "<?php echo e($statusEndDate ?? Carbon\Carbon::today()->format('Y-m-d')); ?>",
    currentPeriod: 'today',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kates\Documents\IT12final\IT12L_FullProject_ERP\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>