                                    ...
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th
                                                ...
                                                Amount</th>
                                            <th
                                                class="py-2 px-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                Date</th>
                                        </tr>
                                    </thead>
                                    <tbody class="divide-y divide-gray-200">
                                        @foreach($order->payments as $payment)
                                            <tr>
                                                ...
                                                <td class="py-2 px-4 text-center">{{ $payment->created_at->format('M d, Y H:i') }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="amount" id="amount" step="0.01" min="0.01"
                                    ...
                                    class="pl-7 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    required>
                            </div>
                            <p class="text-sm text-gray-500 mt-1">Maximum amount: ₱{{ number_format($remainingAmount, 2) }}
                            </p>
                        </div>
