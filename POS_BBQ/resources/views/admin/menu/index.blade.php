            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('categories.index') }}"
                        class="px-4 py-2 bg-gray-600 text-white rounded hover:bg-gray-700">Manage Categories</a>
                    <a href="{{ route('menu.create') }}"
                        class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Add New Item</a>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="py-2 px-4 text-center">
                                    ...
                                    <form id="deleteMenuForm{{ $item->id }}" action="{{ route('menu.destroy', $item) }}"
                                        ...
                                        @method('DELETE')
                                        <button type="button"
                                            onclick="showConfirm('Are you sure you want to archive this menu item?', function() { document.getElementById('deleteMenuForm{{ $item->id }}').submit(); })"
