                        ...
                        <table class="table detail-table mb-0">
                            ...
                            <tfoot>
                                <tr class="total-row">
                                    ...
                                    <td class="total-amount"><strong>₱{{ number_format($order->total_amount, 2) }}</strong></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
            ...
            <div class="card detail-card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="detail-item border-top pt-3 mt-3">
                        ...
                        <span class="detail-value total-highlight">₱{{ number_format($order->total_amount, 2) }}</span>
                    </div>
                </div>
            </div>
