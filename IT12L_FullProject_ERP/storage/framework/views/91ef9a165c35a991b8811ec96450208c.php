                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <?php if($item->product_image): ?>
                                                        <img src="<?php echo e(asset('images/' . $item->product_image)); ?>"
                                                            alt="<?php echo e($item->product_name); ?>" class="product-image me-3">
                                                    <?php else: ?>
                                ...
                                <tfoot>
                                    <tr class="total-row">
                                        ...
                                        <td class="total-amount">
                                            <strong>₱<?php echo e(number_format((float)$order->total_amount, 2)); ?></strong></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        ...
                        <form action="<?php echo e(route('admin.orders.updateStatus', $order->id)); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-select status-select" required>
                                    ...
                                    <option value="confirmed" <?php echo e($order->status == 'confirmed' ? 'selected' : ''); ?>>Confirmed
                                    </option>
                                    <option value="preparing" <?php echo e($order->status == 'preparing' ? 'selected' : ''); ?>>Preparing
                                    </option>
                                    <option value="ready" <?php echo e($order->status == 'ready' ? 'selected' : ''); ?>>Ready for Pickup
                                    </option>
                                    <option value="picked up" <?php echo e($order->status == 'picked up' ? 'selected' : ''); ?>>Picked Up
                                    </option>
                ...
                <div class="card detail-card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="detail-item">
                            ...
                            <span
                                class="detail-value"><?php echo e(\Carbon\Carbon::parse($order->created_at)->format('M j, Y g:i A')); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Payment Method:</span>
                            <span class="detail-value">
                                <?php if($order->payment_method === 'qr_ph'): ?>
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">
                                ...
                                <?php echo e($order->branch->name ?? 'Unknown'); ?>

                            </span>
                        </div>
                        <div class="detail-item border-top pt-3 mt-3">
                            <span class="detail-label">Total Amount:</span>
                            <span class="detail-value total-highlight">₱<?php echo e(number_format((float)$order->total_amount, 2)); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card detail-card mb-4">
                    ...
                    <div class="card-body">
                        <div class="detail-item">
                            ...
                            <span class="detail-value"><?php echo e($order->user->name ?? $order->customer_name); ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Email:</span>
                            <span class="detail-value">
                                <i class="fas fa-envelope text-muted me-1"></i>
                                <?php echo e($order->user->email ?? 'Guest Order'); ?>
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">
                                ...
                                <?php echo e($order->user->phone ?? $order->customer_phone); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Videos\projectIT12\IT12L_FullProject_ERP\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>