    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('staff.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">Back
                    to Staff</a>
            </div>
            ...
            <form action="{{ route('staff.update', $staff) }}" method="POST">
                ...
                <div class="flex justify-end">
                    <button type="submit" onclick="return confirm('Are you sure you want to save these changes?')"
                        class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Update Staff Member</button>
                </div>
            </form>
        </div>
    </div>
