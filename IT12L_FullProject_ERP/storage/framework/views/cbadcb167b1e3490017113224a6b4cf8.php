...
<div class="container-fluid my-4">
    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('admin.products.archived')); ?>" class="btn btn-light">
                    <i class="fas fa-archive"></i> Archived Products
                </a>
                <a href="<?php echo e(route('admin.products.create')); ?>" class="btn btn-light">
        ...
        <form method="GET" action="<?php echo e(route('admin.products.index')); ?>">
            <div class="filter-group">
                <div class="form-group">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="Product name..." value="<?php echo e(request('search')); ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="price_range" class="form-select">
                        ...
                        <option value="200-500" <?php echo e(request('price_range') == '200-500' ? 'selected' : ''); ?>>₱200 - ₱500</option>
                        <option value="500+" <?php echo e(request('price_range') == '500+' ? 'selected' : ''); ?>>₱500+</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <?php if(request()->hasAny(['search', 'category_id', 'branch_id', 'is_available', 'price_range'])): ?>
                <div class="form-group">
                    <label class="form-label">&nbsp;</label>
    ...
    <div class="products-table-card">
        <div class="card-header">
            ...
            <span class="badge bg-light text-dark"><?php echo e($products->total()); ?> Total</span>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="products-table table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span class="product-id">#<?php echo e($product->id); ?></span>
                            </td>
                            <td>
                            ...
                            <td>
                                <small class="product-description">
                                    <?php echo e(Str::limit($product->description ?? 'No description', 60)); ?>
                            ...
                            <td>
                                <span class="branch-badge">
                                    ...
                                    <?php echo e($product->branch_name); ?>
                            ...
                            <td>
                                <span class="status-badge <?php echo e($product->is_available ? 'available' : 'unavailable'); ?>">
                        ...
                        <tr>
                            <td colspan="9">
                                <div class="empty-state">
                                    ...
                                    <p><?php echo e(request()->hasAny(['search', 'category_id', 'branch_id', 'is_available', 'price_range']) ? 'No products match your filters.' : 'Start by adding your first product.'); ?></p>
                                    <?php if(!request()->hasAny(['search', 'category_id', 'branch_id', 'is_available', 'price_range'])): ?>
                                    <a href="<?php echo e(route('admin.products.create')); ?>" class="btn btn-light mt-2">
                                        <i class="fas fa-plus"></i> Add New Dish
                                    </a>
                                    <?php endif; ?>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Videos\Project_IT12\sabio\IT12L_Project\IT12L_FullProject_ERP\resources\views/admin/products/index.blade.php ENDPATH**/ ?>