...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
                    ...
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            <a href="{{ route('admin.dashboard') }}">
                                <img src="{{ asset('images/logo2.jpg') }}" style="width: 50px; height: 50px;"
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            @if(Route::has('admin.branches.index'))
                                <x-nav-link :href="route('admin.branches.index')"
                                    :active="request()->routeIs('admin.branches.*')">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            @if(Route::has('admin.feedback.index'))
                                <x-nav-link :href="route('admin.feedback.index')"
        ...
        <!-- Form Confirm Helper -->
        @if(view()->exists('components.form-confirm-helper'))
            @include('components.form-confirm-helper')
        @endif

        <!-- Flash Messages -->
        @if(view()->exists('components.flash-messages'))
