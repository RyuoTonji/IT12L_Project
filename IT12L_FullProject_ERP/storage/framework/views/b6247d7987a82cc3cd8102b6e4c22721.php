...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark"
     style="<?php echo e(auth()->check() && auth()->user()->is_admin ? 'background-color: #000;' : 'background-color: #A52A2A;'); ?>">
    <div class="container<?php echo e(auth()->check() && auth()->user()->is_admin ? '-fluid' : ''); ?>">
        <a class="navbar-brand" href="<?php echo e(auth()->check() && auth()->user()->is_admin ? route('admin.dashboard') : route('home')); ?>">
         ...
         style="max-width: 50px; height: auto !important;"> 
            <?php echo e(auth()->check() && auth()->user()->is_admin ? 'Admin Panel' : 'BBQ Lagao & Beef Pares'); ?>
...
</html><?php /**PATH C:\Users\User\Videos\Project_IT12\llena\IT12L_FullProject_ERP\resources\views/layouts/app.blade.php ENDPATH**/ ?>