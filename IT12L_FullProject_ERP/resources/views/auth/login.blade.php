                ...
                <div class="col-lg-10 col-xl-9">
                    ...
                    <div class="card shadow-xl border-0" style="border-radius: 0.75rem; overflow: hidden;">
                        <div class="row g-0">
                            ...
                            {{-- Right Side: Login Form (Enhanced Dark Thematic Background) --}}
                       ...
                       text-shadow: 2px 2px 4px rgba(0,0,0,0.2);">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="d-grid gap-2 mt-4">
                                            <button type="submit" class="btn btn-light btn-lg fw-bold py-3 login-btn" style="color: #A52A2A; 
                          ...
                          transition: all 0.3s ease;">
                                            <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg"
                                                alt="Google Logo" class="me-2" style="width: 20px; height: 20px;">
                                    ...
                                    <div class="text-center pt-3 mt-3" style="border-top: 1px solid rgba(255,255,255,0.2);">
                                        ...
                                        <a href="{{ route('register') }}"
                                            class="btn btn-outline-light w-100 fw-bold py-2 register-btn" style="border-radius: 0.5rem; 
                          border-width: 2px;
                          transition: all 0.3s ease;">
