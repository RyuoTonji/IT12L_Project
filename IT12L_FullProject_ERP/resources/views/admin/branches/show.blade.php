...
<div class="container-fluid my-4">
    ...
    <div class="branch-operations-header mb-4">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
            <div>
                <h2 class="mb-2"><i class="fas fa-store"></i> {{ $branch->name }} Operations</h2>
                <div class="branch-meta">
                    <span><i class="fas fa-map-marker-alt"></i> {{ $branch->address }}</span>
                    <span class="mx-2">|</span>
                    <span><i class="fas fa-phone"></i> {{ $branch->phone }}</span>
                </div>
            </div>
            ...
            <ul class="nav nav-tabs" id="branchTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="orders-tab" data-bs-toggle="tab" data-bs-target="#orders" 
                        ...
                        <span class="badge bg-warning ms-2">{{ $activeOrders->count() }}</span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="menu-category-card">
                                        <div class="menu-category-header">
                                            <h6><i class="fas fa-utensils"></i> {{ $category }}</h6>
