                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6 p-5 text-white" style="background-color: #A52A2A; background-image: url('your_background_image.jpg'); background-size: cover; background-position: center; border-radius: 0 0.5rem 0.5rem 0;">
                        <div class="text-center">
                           ...
                           <img src="<?php echo e(asset('images/pares.png')); ?>" alt="BBQ-Lagao Logo" class="img-fluid d-block mx-auto"
                            ...
                            <div class="card h-100 shadow-sm border-2 border-primary hover-shadow">
                                <div class="card-body">
                                    <h3 class="card-title text-primary mb-3">
                                        <i class="fas fa-store"></i> <?php echo e($branch->name); ?>

                                    </h3>
                                    <p class="card-text text-muted">
                                        <i class="fas fa-map-marker-alt text-danger me-2"></i> <?php echo e($branch->address); ?><br>
                                        <i class="fas fa-phone text-success me-2"></i> <?php echo e($branch->phone); ?>

                                    </p>
                                    <a href="<?php echo e(route('browse', $branch->id)); ?>" class="btn btn-primary w-100 mt-3">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Videos\Project_IT12\llena\IT12L_FullProject_ERP\resources\views/user/home/index.blade.php ENDPATH**/ ?>