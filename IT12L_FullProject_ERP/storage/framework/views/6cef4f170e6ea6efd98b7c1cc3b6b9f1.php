    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('admin.customers.create')); ?>" class="btn btn-light">
            ...
            <div class="filter-group">
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <option value="0" <?php echo e(request('status') === '0' ? 'selected' : ''); ?>>Disabled</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="form-label">&nbsp;</label>
                    <a href="<?php echo e(route('admin.customers.index')); ?>" class="btn btn-secondary w-100">
            ...
            <div class="table-responsive">
                <table class="customers-table table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span class="customer-id">#<?php echo e($customer->id); ?></span>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <span class="text-muted"><?php echo e($customer->email); ?></span>
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="status-badge <?php echo e($customer->is_active ? 'active' : 'inactive'); ?>">
                                    <?php echo e($customer->is_active ? 'Active' : 'Disabled'); ?>

                                </span>
                            </td>
                            <td>
                                <i class="fas fa-calendar text-muted me-1"></i>
                                <?php echo e(\Carbon\Carbon::parse($customer->created_at)->format('M j, Y')); ?>

                                <br>
                                <small class="text-muted">
                                    <i class="fas fa-clock me-1"></i>
                                    <?php echo e(\Carbon\Carbon::parse($customer->created_at)->format('g:i A')); ?>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <form action="<?php echo e(route('admin.customers.toggleStatus', $customer->id)); ?>" 
                                          method="POST" 
                                          onsubmit="return confirm('Are you sure you want to <?php echo e($customer->is_active ? 'disable' : 'enable'); ?> this customer?');">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" 
                                                class="btn btn-sm btn-<?php echo e($customer->is_active ? 'secondary' : 'success'); ?>" 
                                                title="<?php echo e($customer->is_active ? 'Disable' : 'Enable'); ?>">
                                            <i class="fas fa-<?php echo e($customer->is_active ? 'ban' : 'check'); ?>"></i>
                                        </button>
                                    </form>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty-state">
                                    ...
                                    <p><?php echo e(request()->hasAny(['search', 'status']) ? 'No customers match your filters.' : 'There are no customers yet.'); ?></p>
                                    <?php if(!request()->hasAny(['search', 'status'])): ?>
                                    <a href="<?php echo e(route('admin.customers.create')); ?>" class="btn btn-success mt-2">
                                        <i class="fas fa-user-plus"></i> Add New Customer
                                    </a>
                                    <?php endif; ?>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Videos\Project_IT12\sabio\IT12L_Project\IT12L_FullProject_ERP\resources\views/admin/customers/index.blade.php ENDPATH**/ ?>