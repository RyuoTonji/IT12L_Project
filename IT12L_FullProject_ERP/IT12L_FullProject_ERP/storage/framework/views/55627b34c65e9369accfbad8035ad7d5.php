...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Food Ordering System'); ?></title>
...
<body>
    <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-dark <?php echo e(auth()->check() && auth()->user()->is_admin ? 'bg-dark' : 'bg-primary'); ?>">
        <div class="container<?php echo e(auth()->check() && auth()->user()->is_admin ? '-fluid' : ''); ?>">
            <a class="navbar-brand" href="<?php echo e(auth()->check() && auth()->user()->is_admin ? route('admin.dashboard') : route('home')); ?>">
                <i class="fas fa-utensils"></i> <?php echo e(auth()->check() && auth()->user()->is_admin ? 'Admin Panel' : 'BBQ Lagao & Beef Pares'); ?>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->is_admin): ?>
                        ...
                        <ul class="navbar-nav me-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('admin.branches.index')); ?>">
...
</html><?php /**PATH C:\Users\User\Videos\Project_IT12\sabio\IT12L_Project\IT12L_FullProject_ERP\resources\views/layouts/app.blade.php ENDPATH**/ ?>