    ...
    <div class="row">
        ...
        <div class="col-lg-7">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <strong>Pickup Branch:</strong> <?php echo e($branch->name); ?>

                        <br>
                        <small class="text-muted">
                            <i class="fas fa-map-marker-alt"></i> <?php echo e($branch->address); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                name="notes"
                                rows="3"
                                placeholder="Any special requests or instructions..."><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div class="form-check border rounded p-3 <?php if(old('payment_method') == 'qr_ph'): ?> border-primary bg-light <?php endif; ?>">
                                    <input class="form-check-input" type="radio" name="payment_method" id="payment_qrph" value="qr_ph" <?php echo e(old('payment_method') == 'qr_ph' ? 'checked' : ''); ?>>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal-body-content">
                ...
                <div class="border border-info rounded p-3 mb-3" id="order-summary-section" style="background-color: #d1ecf1; display: block !important; opacity: 1 !important; visibility: visible !important;">
                    ...
                    <ul class="mb-0 mt-2">
                        <li><strong>Branch:</strong> <?php echo e($branch->name); ?></li>
                        <li><strong>Items:</strong> <?php echo e($items->count()); ?> item(s)</li>
                        <li><strong>Total:</strong> ₱<?php echo e(number_format($total, 2)); ?></li>
                ...
                <div id="paymongo-qr-section" style="display: none;" class="text-center mb-3">
                    ...
                    <div class="qr-container p-3 border rounded bg-white d-inline-block shadow-sm">
                        ...
                        <p class="small text-muted mt-3 mb-0">
                            <strong>Amount: ₱<?php echo e(number_format($total, 2)); ?></strong><br>
    ...
    (function() {
        ...
        function startPaymentPolling(orderId) {
            const pollInterval = setInterval(() => {
                fetch("<?php echo e(route('checkout.check_status')); ?>?order_id=" + orderId)
                    .then(response => response.json())
                    .then(data => {
                        if (data.success && data.status === 'paid') {
                            ...
                            setTimeout(() => {
                                window.location.href = "<?php echo e(route('checkout.confirm')); ?>?order_id=" + orderId;
                            }, 2000);
                        }
                    })
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Videos\projectIT12\IT12L_FullProject_ERP\resources\views/user/checkout/index.blade.php ENDPATH**/ ?>