        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="mb-0 text-white-50">
                    ...
                    Customer ID: #<?php echo e($customer->id); ?>
            ...
            <div class="card detail-card mb-4">
                ...
                <div class="card-body">
                    <div class="detail-item">
                        ...
                        <span class="detail-value customer-id">#<?php echo e($customer->id); ?></span>
                    </div>
                    <div class="detail-item">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">
                            ...
                            <?php echo e($customer->address ?? 'N/A'); ?>
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($customer->created_at)->format('M j, Y g:i A')); ?></span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Last Updated:</span>
                        <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($customer->updated_at)->format('M j, Y g:i A')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="card detail-card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('admin.customers.edit', $customer->id)); ?>" class="btn btn-warning w-100">
                            <i class="fas fa-edit"></i> Edit Customer
                        </a>
                        
                        <form action="<?php echo e(route('admin.customers.toggleStatus', $customer->id)); ?>" 
                              method="POST"
                              onsubmit="return confirm('Are you sure you want to <?php echo e($customer->is_active ? 'disable' : 'enable'); ?> this account?');">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-<?php echo e($customer->is_active ? 'secondary' : 'success'); ?> w-100">
                                <i class="fas fa-<?php echo e($customer->is_active ? 'ban' : 'check'); ?>"></i> 
                                <?php echo e($customer->is_active ? 'Disable Account' : 'Enable Account'); ?>
                            ...
                            <table class="table detail-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="price-cell">₱<?php echo e(number_format($order->total_amount, 2)); ?></td>
                                        <td>
                                            <?php
                                                $statusClass = [
                                                    'pending' => 'pending',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kates\Documents\IT12final\IT12L_FullProject_ERP\resources\views/admin/customers/show.blade.php ENDPATH**/ ?>