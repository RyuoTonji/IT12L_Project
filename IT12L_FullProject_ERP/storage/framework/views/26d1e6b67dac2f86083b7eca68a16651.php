    ...
    <div id="empty-cart" class="d-none">
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <a href="<?php echo e(route('home')); ?>" class="btn btn-maroon">
                    ...
                    <div class="card-body">
                        ...
                        <div id="checkout-section">
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e(route('login')); ?>?redirect=checkout" class="btn btn-maroon w-100 mb-2">
                                    <i class="fas fa-sign-in-alt"></i> Login to Checkout
                                </a>

                                <a href="<?php echo e(route('register')); ?>" class="btn btn-maroon-outline w-100 mb-2">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Vanessa\Desktop\IT12_L\IT12L_FullProject_ERP\resources\views/user/cart/index.blade.php ENDPATH**/ ?>